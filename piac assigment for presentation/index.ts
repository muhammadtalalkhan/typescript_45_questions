...
let arr: string[] = ["Hello", "Jamal", "Javed", "Jamshed", "Junaid"];
...
var arr2: string[] = ["Hello", "Jamal", "Javed", "Jamshed", "Junaid"];
...
var arr4: string[] = ["Hello", "Jamal", "Javed", "Jamshed", "Junaid"];
...
var arr5: string[] = ["Jamal", "Javed", "Jamshed", "Junaid"];
...
var arr6: string[] = ["Hello", "Jamal", "Javed", "Jamshed", "Junaid"];
